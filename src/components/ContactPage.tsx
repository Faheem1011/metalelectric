...
export const ContactPage: React.FC<ContactPageProps> = ({ lang }) => {
  ...
  const t = {
    EN: {
      ...
      successDesc: "Your technical query has been successfully routed to our engineering desk in Okara. An application engineer will contact you shortly.",
      heading: "Submit Engineering Inquiry",
    ...
    UR: {
      ...
      successDesc: "آپ کی انکوائری ہمارے اوکاڑہ آفس کو موصول ہو گئی ہے۔ ہمارے انجینئرز جلد ہی آپ سے رابطہ کریں گے۔",
      ...
      factoryAddress: "فیصل آباد روڈ، اوکاڑہ، پاکستان"
    }
  }[lang];
            ...
            <div className="rounded-2xl border border-zinc-900 bg-[#090909] p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-zinc-400">
                ...
                <div className="flex items-start space-x-3 border-t border-zinc-900 pt-4">
                  ...
                  <div>
                    <span className="block font-bold text-white text-xs uppercase font-mono">CALL HOTLINE / WHATSAPP</span>
                    <span className="font-mono text-zinc-300 font-bold block mt-1">+92 309 8000565 / +92 344 6760259</span>
                  </div>
                </div>
